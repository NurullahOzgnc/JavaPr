...
public class Dusman1AI : MonoBehaviour
{
    ...
    private float attackCooldown = 1f; // Ýki saldýrý arasý bekleme süresi
    ...
    {
        Collider2D[] hitPlayer = Physics2D.OverlapCircleAll(attackPoint.position, 1f, playerLayer);
        foreach (var player in hitPlayer)
        {

            player.GetComponent<Fire_Knight_Combat>().takeDamage(25f);
        }
    }
}
